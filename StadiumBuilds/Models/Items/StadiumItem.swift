...
struct StadiumItem {
    ...
    static let weaponRare: [StadiumItem] = [
        ...
        StadiumItem(name: "Advanced Nanobiotics", hero: nil, imageString: "Advanced Nanobiotics", type: .weapon, buffs: [Buff(stat: .weaponPower, value: 5)], description: "After healing an ally, gain 10% Attack Speed for 3s.", rarity: .rare, cost: 4000),
    ...
    static let abilityCommon: [StadiumItem] = [
        ...
        StadiumItem(name: "Shady Spectacles", hero: nil, imageString: "Shady Spectacles", type: .ability, buffs: [Buff(stat: .abilityLifesteal, value: 10)], description: "", rarity: .common, cost: 1000),
